...
transformed parameters {
  ...
  real <lower=0> betaDayTrans_1[7];     // day-of-the-week effect (excluding baseline day, first period)
  real <lower=0> betaDayTrans_2[7];     // day-of-the-week effect (excluding baseline day, second period)
  real A[Nwaves];
  ...
  // 'which( nCov_Merged[nCov_Merged$reporting_unit == "Peru",]$time == as.Date("2021-06-01") )' outputs 467
